...
from common_metrics_on_video_quality import calculate_fvd,calculate_fvd_given_timestamp
...
if __name__ == "__main__":
    ...
    # results = calculate_fvd_given_timestamp(torch.randn(20,3,16,128,128,device="cuda"),torch.randn(20,3,16,128,128,device="cuda"),device="cuda",clip_time_stamp=16,method='videogpt',need_channel_adjustment=False)
