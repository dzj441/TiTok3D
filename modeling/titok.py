...
from modeling.modules.blocks import TiTok3DEncoder, TiTok3DDecoder,TiTokEncoder,TiTokDecoder,TiTok3DSpatialTemporalEncoder,TiTok3DSpatialTemporalDecoder
...
class TiTok3DSpatialTemporal(BaseModel,PyTorchModelHubMixin):
    def __init__(self, config):
        ...
        self.encoder = TiTok3DSpatialTemporalEncoder(config)
        self.decoder = TiTok3DSpatialTemporalDecoder(config)
