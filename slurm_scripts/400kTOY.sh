...
WANDB_MODE=online accelerate launch --num_machines=1 --num_processes=8 --machine_rank=0 scripts/train_titok3D.py config=configs/training/titok3D_ll32_vae_toy.yaml \
